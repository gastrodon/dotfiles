{ config, pkgs, lib, ... }:
{
  ...
  # Optional: Factorio-specific environment variables
  environment.sessionVariables = {
    # Steam library folder - Factorio will be installed here
    # STEAM_EXTRA_COMPAT_TOOLS_PATHS = "/home/eva/.steam/root/compatibilitytools.d";
  };
}
